...
void sendCurrentWindow(char window[][BUFFER_SIZE], int windowTail,
...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        if (receiverLength > 0) {
            ...
            sendCurrentWindow(window, windowTail, socketfd, &receiverAddr, receiverAddrLength);
            
            // listen for ACKs and send subsequent packets
            while (1) {
                cout << "im awake before receive!" << endl;
                ...
                cout << "im awake after receive!" << endl;
